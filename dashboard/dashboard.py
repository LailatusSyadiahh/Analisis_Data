...
# Dapatkan direktori saat ini (di mana script dashboard.py berada)
current_dir = os.path.dirname(__file__)

# Gabungkan path untuk menuju file 'day.csv' di folder 'data'
data_path = os.path.join(current_dir, '..', 'data', 'day.csv')

# Baca file CSV menggunakan path yang sudah digabungkan
data = pd.read_csv(data_path)

# Lanjutkan dengan analisis data kamu
